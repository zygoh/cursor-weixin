...
Write-Host "  3. Merge examples/hooks.json into .cursor/hooks.json"
Write-Host "  4. Set .cursor/cli.json approvalMode to unrestricted (optional, for auto agent wake)"
